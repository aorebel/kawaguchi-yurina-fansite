...
<p>Effective date: 2021-11-28</p>
<p>Updated on: 2021-11-28</p>
<p>
  This Privacy Policy explains the policies of Divina Grace Caranto on the collection 
and use of the information we collect when you access https://kawaguchi-yurina-fansite.herokuapp.com/ (the “Service”). This Privacy Policy describes your 
...
<p>Divina Grace Caranto is authorized to modify this Privacy Policy at any time.
This may occur without prior notice.</p>
<p>
  Divina Grace Caranto will post the revised Privacy Policy on the https://kawaguchi-yurina-fansite.herokuapp.com/ website</p>
...
contact or identify you. https://kawaguchi-yurina-fansite.herokuapp.com/ collects the following information:    </p>
    ...
    <p>
      https://kawaguchi-yurina-fansite.herokuapp.com/ collects and receives information from you in the following manner:    </p>
    <ul>
    ...
    <p>
      Your information will be stored for up to 120 days after it is
...
personally may be stored indefinitely.    </p>
        ...
        <p>
          https://kawaguchi-yurina-fansite.herokuapp.com/ may use your information for the following purposes:        </p>
        <ul>
                        <li><b>Providing and maintaining our Service,</b> as well as monitoring the usage of our Service.</li>
                        <li><b>For other purposes.</b> Divina Grace Caranto will use your information for data analysis to identify usage
...
Service that are available to registered users.</li>
                        <li><b>To contact you.</b> Divina Grace Caranto will contact you by email, phone, SMS, or another form of
...
necessary or reasonable.</li>
                        ...
                        <li><b>Marketing and promotional initiatives.</b> Divina Grace Caranto will use non-specific information gathered
...
address, will be in public view when posting user to user comments.</li>
                  </ul>
    
            <h4>How We Share Your Information</h4>
        <p>
          Divina Grace Caranto will share your information, when applicable, in the following situations:        </p>
        <ul>
                      <li><b>With your consent.</b> Divina Grace Caranto will share your information for any purpose with your explicit
consent.</li>
                  </ul>
...
our Service and/or interactions with providers.</li>
                      <li><b>Improving targeted advertising campaigns.</b> Divina Grace Caranto partners with third party service providers to improve
targeted advertising campaigns.</li>
                  </ul>
        <p>
          If you choose to provide such information during registration or 
otherwise, you are giving Divina Grace Caranto permission to use, share, and store that information in a manner consistent with 
...
user login and account management. The website cannot be used properly without strictly necessary cookies.</li>
    ...
    <h4>Security</h4>
    <p>
      Your information’s security is important to us. https://kawaguchi-yurina-fansite.herokuapp.com/ 
...
own risk.    </p>
    <p>
      Divina Grace Caranto is not responsible for the performance of websites 
...
privacy practices of other websites you interact with and determine the adequacy of those practices.    </p>
    ...
    <p>Name: Divina Grace Caranto</p>
    <p>Address: 363 Mataraki St. Brgy. Coral, Paniqui, Tarlac PH 2307</p>
    <p>Email: aorebels@gmail.com</p>
    <p>Website: https://kawaguchi-yurina-fansite.herokuapp.com/</p>
